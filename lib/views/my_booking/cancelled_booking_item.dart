...
class CancelledBookingItem extends StatefulWidget {
  final BookingData bookingData;

  const CancelledBookingItem({Key? key, required this.bookingData})
      : super(key: key);

  @override
  State<CancelledBookingItem> createState() => _CancelledBookingItemState();
}

class _CancelledBookingItemState extends State<CancelledBookingItem> {
